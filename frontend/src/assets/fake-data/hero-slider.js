const slider_1 = require("../images/slider/slider_1.png");
const slider_2 = require("../images/slider/slider_2.png");
const slider_3 = require("../images/slider/slider_3.png");

const heroSliderData = [
  {
    title: "Tư duy nhanh và chậm",
    description:
      "Thinking fast and slow, cuốn sách nổi tiếng tổng hợp tất cả nghiên cứu được tiến hành qua nhiều thập kỷ của nhà tâm lý học từng đạt giải Nobel Kinh tế Daniel Kahneman sẽ cho bạn thấy những sư hợp lý và phi lý trong tư duy bản thân. Cuốn sách được đánh giá là “kiệt tác” trong việc thay đổi hành vi của con người, Thinking fast and slow đã giành được vô số giải thưởng danh giá, lọt vào Top 11 cuốn sách kinh doanh hấp dẫn nhất năm 2011.",
    image: slider_1,
    color: "black",
