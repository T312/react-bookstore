...
export const ORDER_LIST_SHIP_REQUEST = "ORDER_LIST_SHIP_REQUEST";
export const ORDER_LIST_SHIP_SUCCESS = "ORDER_LIST_SHIP_SUCCESS";
export const ORDER_LIST_SHIP_FAIL = "ORDER_LIST_SHIP_FAIL";
